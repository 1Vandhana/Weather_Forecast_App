...
- >Displays temperature, humidity, and wind speed for upcoming days.
...
|-> Screenshorts that How my project works->WFApp->1)Webpage screenshort
...
->Used Commands for uploading files like->git clone (adding the repo),git add.,git commit -U(for new files),git commit -m (for modified   files),git push(for pushing file into rep),git pull origin main,git pull --rebase origin main (for rebase)etc.
-----------------------
//--USAGE--//

->Enter a city name in the input field.
->Click the Get Weather button.
->Weather forecast cards will display below, 
showing: 1.Date and time
         2.Temperature (°C)
         3.Humidity (%)
         4.Wind speed (m/s)
